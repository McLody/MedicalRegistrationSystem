...
import com.mclody.mrs.enums.OrderStatusEnum;
import com.mclody.mrs.hosp.client.HospitalFeignClient;
import com.mclody.mrs.model.order.OrderInfo;
import com.mclody.mrs.model.user.Patient;
import com.mclody.mrs.order.mapper.OrderInfoMapper;
import com.mclody.mrs.order.service.OrderService;
import com.mclody.mrs.order.service.WeixinService;
import com.mclody.mrs.rabbit.service.RabbitService;
import com.mclody.mrs.rabbit.service.config.MqConfig;
import com.mclody.mrs.user.client.PatientFeignClient;
import com.mclody.mrs.vo.hosp.ScheduleOrderVo;
import com.mclody.mrs.vo.msm.MsmVo;
import com.mclody.mrs.vo.order.*;
...
public class OrderServiceImpl extends
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        ...
        if(new DateTime(scheduleOrderVo.getStartTime()).isAfterNow()
            ...
            throw new MrsException(ResultCodeEnum.TIME_NO);
        }
        ...
        if(scheduleOrderVo.getAvailableNumber() <= 0) {
            throw new MrsException(ResultCodeEnum.NUMBER_NO);
        }
        ...
        if(result.getInteger("code") == 200) {
            ...
            rabbitService.sendMessage(MqConfig.EXCHANGE_DIRECT_ORDER, MqConfig.ROUTING_ORDER, orderMqVo);

        } else {
            throw new MrsException(result.getString("message"), ResultCodeEnum.FAIL.getCode());
        }
...
//            throw new MrsException(ResultCodeEnum.CANCEL_ORDER_NO);
//        }
...
//已支付 退款
                ...
                if(!isRefund) {
                    throw new MrsException(ResultCodeEnum.CANCEL_ORDER_FAIL);
                }
            }
//更改订单状态
...
//短信提示
    ...
    public void patientTips() {
        ...
        for(OrderInfo orderInfo : orderInfoList) {
            ...
            msmVo.setParam(param);
            rabbitService.sendMessage(MqConfig.EXCHANGE_DIRECT_MSM, MqConfig.ROUTING_MSM_ITEM, msmVo);
        }
    }
