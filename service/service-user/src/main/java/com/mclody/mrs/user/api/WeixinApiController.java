package com.mclody.mrs.user.api;
...
import com.mclody.mrs.user.util.ConstantPropertiesUtil;
import com.mclody.mrs.user.util.HttpClientUtils;
...
public class WeixinApiController {
    ...
    public String callback(String code, String state) {
        ...
        if (StringUtils.isEmpty(state) || StringUtils.isEmpty(code)) {
            log.error("非法回调请求");
            throw new MrsException(ResultCodeEnum.ILLEGAL_CALLBACK_REQUEST_ERROR);
        }
        ...
        try {
            ...
            throw new MrsException(ResultCodeEnum.FETCH_ACCESSTOKEN_FAILD);
        }
        ...
        try {
            ...
            throw new MrsException(ResultCodeEnum.FETCH_USERINFO_ERROR);
        }
